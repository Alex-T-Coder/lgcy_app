...
describe('User routes', () => {
  ...
  describe('GET /api/users', () => {
    test('should return 200 and apply the default query options', async () => {
      ...
      expect(res.body.result.users).toHaveLength(3);
      expect(res.body.result.users[0]).toEqual({
    ...
    test('should correctly apply filter on name field', async () => {
      ...
      expect(res.body.result.users).toHaveLength(1);
      expect(res.body.result.users[0].id).toBe(userOne._id.toHexString());
    });
    ...
    test('should correctly apply filter on role field', async () => {
      ...
      expect(res.body.result.users[0].id).toBe(userOne._id.toHexString());
      expect(res.body.result.users[1].id).toBe(userTwo._id.toHexString());
    });
    ...
    test('should correctly sort the returned array if descending sort param is specified', async () => {
      ...
      expect(res.body.result.users[0].id).toBe(userOne._id.toHexString());
      expect(res.body.result.users[1].id).toBe(userTwo._id.toHexString());
      expect(res.body.result.users[2].id).toBe(admin._id.toHexString());
    });
    ...
    test('should correctly sort the returned array if ascending sort param is specified', async () => {
      ...
      expect(res.body.result.users).toHaveLength(3);
      expect(res.body.result.users[0].id).toBe(admin._id.toHexString());
      expect(res.body.result.users[1].id).toBe(userOne._id.toHexString());
      expect(res.body.result.users[2].id).toBe(userTwo._id.toHexString());
    });
    ...
    test('should correctly sort the returned array if multiple sorting criteria are specified', async () => {
      ...
      expectedOrder.forEach((user, index) => {
        expect(res.body.result.users[index].id).toBe(user._id.toHexString());
      });
    });
